...
export default function ProductEdit() {
  ...
  const submit = async (event) => {
    ...
    setMessage('');
    try {
      await apiClient.put(`/admin/products/${encodeURIComponent(id)}/edit`, form);
